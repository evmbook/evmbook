...
**EOS (2018)**: Promised high TPS through Delegated Proof of Stake (DPoS). Made transactions "free" (no gas) but required staking for resources. The centralization of 21 block producers and governance issues led to a decline.
