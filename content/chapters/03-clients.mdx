...
<Note>
All ETC clients will require updates for the **Olympia upgrade** (ECIP-1111 through ECIP-1121), which brings EIP-1559-style transactions and new opcodes (PUSH0, MCOPY, TLOAD/TSTORE) to Ethereum Classic. Check the respective client release pages for Olympia-compatible versions.
</Note>
