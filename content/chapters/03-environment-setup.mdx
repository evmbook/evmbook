...
├─────────────────────────────────────────────────────────────┤
│                    NETWORKS                                  │
│  Mainnet (ETH/ETC) | Testnets (Sepolia/Mordor) | L2s        │
└─────────────────────────────────────────────────────────────┘
```

## Installing Foundry

Foundry is the standard toolchain for professional Solidity development. It's fast, written in Rust, and lets you write tests in Solidity.
...
viem is the modern standard—type-safe, tree-shakeable, and designed for TypeScript:
...
The Graph is the standard for production dApps:
...
Modern AI assistants like Claude (via Claude Code) understand Solidity deeply. Use them for:
...
```bash
# Claude Code for Solidity development
claude "Write a minimal ERC-20 token with permit functionality"
```
...
Key points:
- **Foundry** is the professional choice for smart contract development
- **TypeScript** is the default for scripts and frontends
- **viem** is the modern, type-safe client library
