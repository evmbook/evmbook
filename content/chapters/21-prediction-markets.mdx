...
Robin Hanson's **Logarithmic Market Scoring Rule (LMSR)** was the first practical automated market maker for prediction markets. Published in "Combinatorial Information Market Design" (2003), LMSR solved a critical problem: how to provide liquidity in markets with few participants. [@hanson_lmsr_2003]
...
- [@hanson_lmsr_2003] — Robin Hanson's Logarithmic Market Scoring Rule, foundational to prediction market AMMs
- [@hanson_futarchy_2000] — Original futarchy proposal for governance by prediction market
- [@gnosis_conditional_tokens_2019] — Conditional Token Framework specification
- [@uma_optimistic_oracle_2020] — UMA's optimistic oracle design
- [@buterin_prediction_markets_2014] — Early Ethereum prediction market concepts
