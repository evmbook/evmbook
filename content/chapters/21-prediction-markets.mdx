...
Robin Hanson's **Logarithmic Market Scoring Rule (LMSR)** was the first practical automated market maker for prediction markets. Published in "Combinatorial Information Market Design" (2003), LMSR solved a critical problem: how to provide liquidity in markets with few participants. [@article_hanson_lmsr_2003]
